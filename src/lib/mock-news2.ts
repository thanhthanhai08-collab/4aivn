...
export const mockNews2: NewsArticle[] = [
  ...
  <p>Nhưng theo báo cáo của Decision Lab thật bất ngờ khi người dùng lại dùng AI để tra cứu thuốc và sức khỏe cho thấy sự tin tưởng của người Việt vào các công cụ AI cho các vấn đề cần sự chính xác cao.</p>
...
<p>Chỉ cần mô tả bất kỳ câu chuyện nào bạn có thể hình dung, Gemini sẽ tạo ra một cuốn sách 10 trang độc đáo với hình ảnh minh họa và giọng đọc tùy chỉnh. Để tăng tính cá nhân hóa, bạn có thể yêu cầu Gemini lấy cảm hứng từ chính ảnh hoặc bản vẽ tay của bạn hoặc con bạn.</p>
<p>Một ưu điểm nổi bật là tất cả quá trình tạo truyện và giọng đọc đều được thực hiện trực tiếp trên <em>Canvas của Gemini</em>, giúp bạn thao tác nhanh gọn mà không cần chuyển sang ứng dụng khác.</p>
<p>Hiện tại, Gemini cung cấp hai tùy chọn giọng đọc cơ bản: giọng cao (thường là giọng nữ) và giọng trầm (thường là giọng nam). Người dùng chưa thể sử dụng giọng của chính mình để tăng tính cá nhân hóa, nhưng chắc chắn Google sẽ sớm cập nhật tính năng này.</p>
<h2><strong>Khám phá sự đa dạng trong phong cách và ngôn ngữ</strong></h2>
<p>Bạn có thể hiện thực hóa ý tưởng của mình theo nhiều phong cách khác nhau: từ <em>pixel art</em>, truyện tranh, claymation, crochet cho đến sách tô màu. Hơn nữa, tính năng này hỗ trợ hơn <strong>45 ngôn ngữ</strong> – bao gồm cả tiếng Việt – giúp mở rộng khả năng sáng tạo không giới hạn.</p>
<h2><strong>Chất lượng đến từ Gemini 2.5 Flash và Gemini 2.5 Pro</strong></h2>
<p>Người dùng có thể trải nghiệm miễn phí tính năng này trên cả <strong>Gemini 2.5 Pro</strong> và <strong>Gemini 2.5 Flash</strong>. Tuy nhiên, sách được tạo bởi Pro thường cho kết quả mượt mà và chi tiết hơn, trong khi Flash vẫn đủ dùng cho các trải nghiệm cơ bản.</p>
<p>Vì hoạt động trực tiếp trên Canvas, bạn có thể sử dụng tính năng kể chuyện ở bất kỳ đâu – từ máy tính để bàn cho đến thiết bị di động.</p>
