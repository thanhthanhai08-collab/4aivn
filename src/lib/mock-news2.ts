...
<p><em>Kết quả minh họa sách Gemini</em></p>`,
  ...
  },
  {
    ...
    title: 'Perplexity Comet và ChatGPT Atlas: Cuộc Chiến Trình Duyệt AI Định Hình Lại Internet',
    source: 'Tổng hợp',
    author: 'Mai',
...
<div class="data-source">Nguồn: <a href="https://gs.statcounter.com/browser-market-share" target="_blank">Statcounter Global Stats, tháng 9 năm 2025</a></div>
...
<div class="data-source">Nguồn: Phân tích tổng hợp từ ScaleVise và Digit.in</div>
</div>
...
<p>Sự cạnh tranh này đang thúc đẩy một thị trường hoàn toàn mới. Thị trường trình duyệt AI được dự báo sẽ tăng trưởng mạnh mẽ, từ 4,5 tỷ USD vào năm 2024 lên đến <a href="https://market.us/report/ai-browser-market/" target="_blank">76,8 tỷ USD vào năm 2034</a>, với tốc độ tăng trưởng kép hàng năm (CAGR) là 32,8%. Điều này cho thấy tiềm năng to lớn và sự thay đổi căn bản trong cách ngành công nghệ nhìn nhận về vai trò của trình duyệt.</p>
<div class="chart-wrapper" id="chart3"></div>
<div class="data-source">Nguồn: <a href="https://market.us/report/ai-browser-market/" target="_blank">Market.us, 2024</a></div>
