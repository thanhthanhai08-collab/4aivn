...
export const mockAIModels: AIModel[] = [
  ...
  {
    id: 'claude-4-opus',
    name: 'Claude 4 Opus', // Matched with Claude 3 Opus in previous data, updating
    type: 'Mô hình ngôn ngữ lớn',
    developer: 'Anthropic',
  ...
  },
  {
    ...
    link: 'https://www.anthropic.com/news/claude-3-5-sonnet', // Updated link
    userRating: 4.9,
  ...
  },
  {
    ...
    userRating: 4.4, // Based on intelligence score relative to others
  ...
  },
  {
    ...
    userRating: 4.3, // Based on intelligence score relative to others
