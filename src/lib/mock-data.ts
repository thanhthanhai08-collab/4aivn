...
export const mockTools: Tool[] = [
  ...
  },
  {
    ...
    developer: 'Google',
    ranking: 2,
    description: 'Mô hình tạo hình ảnh từ văn bản thế hệ mới nhất của Google, nổi tiếng với khả năng tạo ra hình ảnh quang học, chi tiết và hiểu sâu sắc các gợi ý phức tạp.',
    logoUrl: '/image/Logo Gemini cho bảng xếp hạng.png',
    link: 'https://deepmind.google/technologies/imagen-4/',
    features: ['Tạo ảnh chân thực', 'Hiểu gợi ý phức tạp', 'Khả năng tạo văn bản trong ảnh', 'Sáng tạo nghệ thuật'],
    userRating: 4.7,
    ratingCount: 135,
    isFavorite: true,
  },
