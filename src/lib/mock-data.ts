...
export const mockAIModels: AIModel[] = [
  ...
  {
    id: 'gpt-4o-mini', // ID was gpt-4 in previous data, changed to match name
    name: 'Open AI o3-mini (high)', // Name was GPT-4 in previous data
    type: 'Mô hình ngôn ngữ lớn',
    developer: 'OpenAI',
    ...
    userRating: 4.7, // Rating updated to 4.7 as per user request
  ...
  },
   {
    ...
    logoUrl: '/image/Logo Gemini cho bảng xếp hạng.png',
    link: 'https://deepmind.google/technologies/gemini/',
    userRating: 4.9, // Kept high to ensure it ranks well
  ...
  {
    id: 'claude-3-opus-thinking', // ID changed from 'claude-3-opus' to be more specific
    name: 'Claude 4 Opus Thinking',    // Name was Claude 3 Opus
    type: 'Mô hình ngôn ngữ lớn',
    developer: 'Anthropic',
  ...
  {
    id: 'claude-4-opus', // Matched with Claude 3 Opus in previous data, updating
    name: 'Claude 4 Opus', // Name was Claude 3 Opus
    type: 'Mô hình ngôn ngữ lớn',
    developer: 'Anthropic',
    ...
    link: 'https://www.anthropic.com/news/claude-3-family',
    userRating: 4.9, // Kept the rating consistent with 'claude-4-opus-thinking' for ranking
  ...
  {
    id: 'claude-3.7-sonnet-thinking', // Was claude-3.5-sonnet-thinking
    name: 'Claude 3.7 Sonnet Thinking', // Was Claude 3.5 Sonnet Thinking
    type: 'Mô hình ngôn ngữ lớn',
    developer: 'Anthropic',
  ...
  },
  {
    ...
    link: 'https://openai.com/',
    userRating: 4.9,
    features: ['Dành cho người dùng chuyên nghiệp', 'Hiệu suất nâng cao', 'Khả năng mở rộng'],
    contextLengthToken: '200k',
  ...
  },
  {
    ...
    logoUrl: 'https://placehold.co/64x64.png?text=C4SNT',
    link: 'https://www.anthropic.com/news/claude-3-family',
    userRating: 4.5,
  ...
  },
  {
    ...
    logoUrl: 'https://placehold.co/64x64.png?text=GPT45P',
    link: 'https://openai.com/',
    userRating: 4.5,
  ...
  },
  {
    ...
    logoUrl: 'https://placehold.co/64x64.png?text=GPT41M',
    link: 'https://openai.com/',
    userRating: 4.5,
  ...
  },
  {
    ...
    logoUrl: 'https://placehold.co/64x64.png?text=GPT41',
    link: 'https://openai.com/',
    userRating: 4.5,
  ...
  },
  {
    ...
    logoUrl: 'https://placehold.co/64x64.png?text=GPT4O',
