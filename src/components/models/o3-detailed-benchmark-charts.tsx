...
const allBenchmarks: Record<string, { modelId: string; score: number }[]> = {
  aime: [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 19.0 },
  ...
  livecode: [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 40.0 },
  ...
  mmlu: [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 81.0 },
  ...
  ifbench: [
      ...
      { modelId: 'seed-oss-36b-instruct', score: 43.0 },
  ...
  gpqa: [
      ...
      { modelId: 'seed-oss-36b-instruct', score: 67.0 },
  ...
  'aa-lcr': [
   ...
   'agentic-coding': [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 0 },
  ...
  'humanitys-exam': [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 4.8 },
  ...
  scicode: [
    ...
    { modelId: 'seed-oss-36b-instruct', score: 33 },
