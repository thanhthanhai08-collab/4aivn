...
const allBenchmarks: Record<string, { modelId: string; score: number }[]> = {
  aime: [
    ...
    { modelId: 'claude-4.5-haiku-thinking', score: 73.0 },
  ...
  livecode: [
    ...
    { modelId: 'claude-4.5-haiku-thinking', score: 64.0 },
  ...
  mmlu: [
    ...
    { modelId: 'claude-4.5-haiku-thinking', score: 87.0 },
  ...
  gpqa: [
      ...
      { modelId: 'claude-4.5-haiku-thinking', score: 80.0 },
