...
const allBenchmarks: Record<string, { modelId: string; score: number }[]> = {
  aime: [
    ...
    { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 64.0 },
  ...
  mmlu: [
    ...
    { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 83.0 },
  ...
  ifbench: [
      ...
      { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 38.0 },
  ...
  gpqa: [
      ...
      { modelId: 'grok-4-fast-reasoning', score: 85.0 },
      { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 73.0 },
  ...
  'aa-lcr': [
   ...
   'agentic-coding': [
    ...
    { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 0 },
    { modelId: 'llama-4-maverick', score: 0 },
    { modelId: 'claude-4.5-sonnet', score: 27 },
  ...
  'humanitys-exam': [
    ...
    { modelId: 'llama-nemotron-super-49b-v1-5-reasoning', score: 8.1 },
    { modelId: 'llama-4-maverick', score: 4.8 },
    { modelId: 'claude-4.5-sonnet', score: 7.1 },
  ...
  scicode: [
    ...
    { modelId: 'llama-4-maverick', score: 33 },
    { modelId: 'claude-4.5-sonnet', score: 43 },
