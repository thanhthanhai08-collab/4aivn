...
const data = {
  ...
  'llama-nemotron-super-49b-v1-5-reasoning': [
    { name: "Agentic Coding", score: 5 },
    { name: "Agentic Tool Use", score: 28 },
    { name: "AA-LCR", score: 34 },
    { name: "Humanity's Exam", score: 6.8 },
    { name: "MMLU-Pro", score: 81 },
    { name: "GPQA Diamond", score: 75 },
    { name: "LiveCodeBench", score: 74 },
  ...
  'qwen3-vl-235b-a22b-reasoning': [
    ...
    { name: "Agentic Tool Use", score: 54 },
    { name: "AA-LCR", score: 59 },
    { name: "Humanity's Exam", score: 10.1 },
    { name: "MMLU-Pro", score: 84 },
    { name: "GPQA Diamond", score: 77 },
    { name: "LiveCodeBench", score: 65 },
    { name: "SciCode", score: 40 },
    { name: "IFBench", score: 56 },
    { name: "AIME 2025", score: 88 },
  ],
  'deepseek-v3.2-exp': [
