                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">{['claude-4.5-sonnet', 'llama-nemotron-super-49b-v1-5-reasoning', 'gpt-5-codex-high', 'grok-4-fast-reasoning', 'claude-4.1-opus-thinking', 'gpt-5-1-high'].includes(model.id) ? 'Có' : (isQwen3 || isDeepseekR1 || model.id === 'deepseek-v3.1-terminus-reasoning' || isClaude45HaikuThinking || isClaude45SonnetThinking || model.id === 'deepseek-v3.2-exp' || model.id === 'qwen3-max' || model.id === 'qwen3-vl-235b-a22b-reasoning' ? 'Không' : 'Có')}</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
