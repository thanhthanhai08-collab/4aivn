                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">{['claude-4.1-opus', 'claude-4.1-opus-thinking', 'llama-nemotron-ultra-reasoning', 'llama-4-maverick', 'gpt-5-codex-high'].includes(model.id) ? 'Có' : (isQwen3 || isDeepseekR1 || model.id === 'deepseek-v3.1-terminus-reasoning' || isClaude4OpusThinking || isClaude45SonnetThinking ? 'Không' : 'Có')}</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
