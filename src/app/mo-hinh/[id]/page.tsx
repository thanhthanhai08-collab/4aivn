...
function ModelDetailContent({ id }: { id: string }) {
  ...
  if (['openai-o3', 'grok-4', 'openai-o3-pro', 'gemini-2.5-pro', 'openai-o4-mini-high', 'gpt-5-high', 'qwen3-235b-reasoning', 'gpt-5-medium', 'deepseek-r1-jan25', 'gemini-2.5-flash-reasoning'].includes(model.id)) {
                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">{model.id === 'openai-o3' ? '20/12/2024' : model.id === 'openai-o4-mini-high' ? '16/04/2025' : (model.id === 'gpt-5-high' || model.id === 'gpt-5-medium') ? '07/08/2025' : model.id === 'qwen3-235b-reasoning' ? '25/07/2025' : model.id === 'deepseek-r1-jan25' ? '28/05/2025' : model.id === 'gemini-2.5-flash-reasoning' ? '17/06/2025' : '09/07/2025'}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                
                 {['openai-o3', 'grok-4', 'gemini-2.5-pro', 'openai-o4-mini-high', 'openai-o3-pro', 'gpt-5-high', 'qwen3-235b-reasoning', 'gpt-5-medium', 'deepseek-r1-jan25', 'gemini-2.5-flash-reasoning'].includes(model.id) && (
                    <section>
