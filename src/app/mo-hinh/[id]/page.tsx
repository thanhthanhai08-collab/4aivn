...
function ModelDetailContent({ id }: { id: string }) {
  ...
  if (['openai-o3', 'grok-4', 'openai-o3-pro', 'gemini-2.5-pro', 'gpt-5-mini-medium', 'gpt-5-high', 'qwen3-235b-reasoning', 'gpt-5-medium', 'deepseek-r1-jan25', 'deepseek-v3.1-terminus-reasoning', 'gemini-2.5-flash-reasoning', 'gpt-5-low', 'gpt-oss-120b-high', 'gpt-5-nano', 'claude-4.5-haiku-thinking', 'claude-4.1-opus-thinking', 'claude-4.5-sonnet-thinking', 'grok-3-mini-reasoning-high', 'grok-4-fast-reasoning', 'llama-nemotron-ultra-reasoning', 'llama-4-maverick', 'claude-4.5-sonnet', 'gpt-oss-20b-high', 'gpt-5-codex-high', 'qwen3-max', 'deepseek-v3.2-exp'].includes(model.id)) {
