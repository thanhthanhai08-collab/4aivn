...
function ModelDetailContent({ id }: { id: string }) {
  ...
  if (['openai-o3', 'grok-4', 'openai-o3-pro', 'gemini-2.5-pro', 'gpt-5-mini-medium', 'gpt-5-high', 'qwen3-235b-reasoning', 'gpt-5-medium', 'deepseek-r1-jan25', 'deepseek-v3.1-terminus-reasoning', 'gemini-2.5-flash-reasoning', 'gpt-5-low', 'gpt-oss-120b-high', 'gpt-5-nano-high', 'claude-4.5-haiku-thinking', 'claude-4.1-opus-thinking', 'claude-4.5-sonnet-thinking', 'grok-3-mini-reasoning-high', 'grok-4-fast-reasoning', 'llama-nemotron-super-49b-v1-5-reasoning', 'llama-4-maverick', 'claude-4.5-sonnet', 'gpt-oss-20b-high', 'gpt-5-codex-high', 'qwen3-max', 'deepseek-v3.2-exp', 'qwen3-vl-235b-a22b-reasoning'].includes(model.id)) {
                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">{['claude-4.5-sonnet', 'claude-4.1-opus-thinking', 'llama-nemotron-super-49b-v1-5-reasoning', 'llama-4-maverick', 'gpt-5-codex-high', 'grok-4-fast-reasoning'].includes(model.id) ? 'Có' : (isQwen3 || isDeepseekR1 || model.id === 'deepseek-v3.1-terminus-reasoning' || isClaude45HaikuThinking || isClaude45SonnetThinking || model.id === 'deepseek-v3.2-exp' || model.id === 'qwen3-max' || model.id === 'qwen3-vl-235b-a22b-reasoning' ? 'Không' : 'Có')}</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
