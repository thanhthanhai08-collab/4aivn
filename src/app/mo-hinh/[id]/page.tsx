...
function ModelDetailContent({ id }: { id: string }) {
  ...
  if (['openai-o3', 'grok-4', 'openai-o3-pro', 'gemini-2.5-pro', 'openai-o4-mini-high', 'gpt-5-high', 'qwen3-235b-reasoning', 'gpt-5-medium', 'deepseek-r1-jan25', 'gemini-2.5-flash-reasoning', 'gpt-5-mini'].includes(model.id)) {
